    ...
    function init_classic_menu() {
        ...
        $(window).scroll(function () {
            ...
            if ($(window).scrollTop() > 0) {
                ...
                $(".inner-nav ul li a:hover, .inner-nav ul li a.active").removeClass("header-nav-active")
                $(".inner-nav ul li a").removeClass("header-nav")
                $(".mobile-nav-icon").removeClass("header-menu")
            }
                ...
                $(".inner-nav ul li a:hover, .inner-nav ul li a.active").addClass("header-nav-active")
                $(".inner-nav ul li a").addClass("header-nav")
                $(".mobile-nav-icon").addClass("header-menu")
            }
